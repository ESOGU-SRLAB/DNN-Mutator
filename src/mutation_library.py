...
tf_vocab_size_values = [
    "vocab_size = 8000",   # Small vocabularies, often used in mobile applications
    "vocab_size = 16000",  # Medium-sized vocabularies, suitable for many common NLP tasks
    "vocab_size = 32000",  # Larger vocabularies, often used for complex models
    "vocab_size = 50000",  # Very large vocabularies, used for extensive text corpora
