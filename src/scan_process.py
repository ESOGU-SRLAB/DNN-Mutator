...
def scan_yes_wl_yes_cs(patterns, source_code_list, painted_lines):
    ...
    for i in painted_lines:
        ...
        find_print = re.findall("print", detected_parts_list_line)
        if (
            not find_function
            and not find_class
            and not find_import
...
def no_wl_no_cs_find_target_line(source_code_list, code_snippet_regex_code_list):
    ...
    for line_number in range(len_source_code_list):
        ...
        find_print = re.findall("print", line)
        if (
            not find_function
            and not find_class
            and not find_import
...
def find_target_no_workload_yes_code_snippet(split_text, patterns):
    ...
    for i, _ in enumerate(split_text):
        ...
        find_comment = re.findall("print", line_from_source_code)
        if (
            not find_function
            and not find_class
            and not find_import
